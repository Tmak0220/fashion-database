export default function SeasonCollectionLoading() {
      ...
      <main className="p-10 md:p-14 lg:p-16 max-w-7xl mx-auto w-full min-h-screen">
        ...
        <section className="border-b border-border/40 pb-14">
          <div className="animate-pulse space-y-3">
            <div className="h-10 sm:h-12 md:h-14 w-64 bg-neutral-100 rounded-lg" />
        ...
        <section className="mt-20">
          <div className="flex items-end justify-between gap-6 mb-12 border-b border-border/40 pb-4">
            <div className="animate-pulse space-y-2">
              <div className="h-6 w-40 bg-neutral-100 rounded-md" />
              <div className="h-3 w-36 bg-neutral-100/80 rounded" />
            </div>
            ...
            {skeletonItems.map((_, index) => (
              <article key={index} className="animate-pulse space-y-4">
                ...
                <div className="space-y-2 px-1">
                  ...
                  <div className="h-4 w-32 bg-neutral-100/70 rounded" />
                </div>
              </article>
            ))}
          </div>
